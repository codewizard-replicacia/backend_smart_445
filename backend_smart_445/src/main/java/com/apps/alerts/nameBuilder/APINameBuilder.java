package com.apps.alerts.nameBuilder;
...
public class APINameBuilder implements JPAEdmNameBuilder {
	...
	public String buildEntitySetName(final String entityTypeName) {
    	...
    	eSetName = "WaterPipe".equals(entityTypeName) ? "WaterPipes" : defaultNameBuilder.buildEntitySetName(entityTypeName);
    	eSetName = "Alert".equals(entityTypeName) ? "Alerts" : defaultNameBuilder.buildEntitySetName(entityTypeName);
        return eSetName;
    }
